...
app.get('/signup', function(req, res) {
    ...
    res.end('<html><p>As a guest, you\'re signing up : </p><form action="." method="post">' +
...
app.post('/signup', function(req, res) {
	...
	res.end("Registeration failed : Firstname missing")
    if (req.body.lastname == "")
	res.end("Registeration failed : lastname missing")
    request.post('http://localhost:4242/user/create',
		 {
		     form : {
		 ...
		 function (error, response, body) {
			 ...
			 res.end("Registaration succeed !");
		     res.end("Registaration failed : " + body);
		 }
		);
});
/*-------------------------*/
